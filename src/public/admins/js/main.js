...
$(function () {
  ...
  $(".step-trigger").on("click", function () {
    ...
    if (
      prev_trigger.length &&
      !prev_trigger.hasClass("active") &&
      !prev_trigger.hasClass("complete")
    )
      return false;
  ...
  if (typeof Chart !== "undefined") {
    ...
    if ($("#liteLineChart").length) {
      ...
      var liteLineGradient = liteLineChart[0]
        .getContext("2d")
    ...
    if ($("#liteLineChartV2").length) {
      ...
      var liteLineGradientV2 = liteLineChartV2[0]
        .getContext("2d")
    ...
    if ($("#liteLineChartV3").length) {
      ...
      var liteLineGradientV3 = liteLineChartV3[0]
        .getContext("2d")
        .createLinearGradient(0, 0, 0, 70);
      ...
      if (liteLineChartV3.data("chart-data"))
        chartDataV3 = liteLineChartV3.data("chart-data").split(",");
